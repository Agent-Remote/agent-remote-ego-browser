...
Release `0.1.8` targets `community-local-trust`:
...
otherwise it publishes a prerelease. Release `0.1.8` passed this component gate
...
Compatibility is exact: wrapper/Bridge/Device Client `0.1.8`, protocol
...
Release `0.1.8` has complete `community-local-trust` component evidence. That
