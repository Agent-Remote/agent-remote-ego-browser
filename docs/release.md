...
The source tree targets `0.1.16`. Its tag-bound release and Sigstore evidence
establish component readiness; root composition and artifact-bound canaries
are separate deployment gates.

## Evidence profile

Release `0.1.16` targets `community-local-trust`:
...
Compatibility is exact: wrapper/Bridge/Device Client `0.1.16`, protocol
