...
/// A release that rotates this key must also update its signed release manifest.
pub const TRUSTED_LEARNING_BUNDLE_PUBLIC_KEY: [u8; 32] = [
    0x8b, 0x1b, 0x38, 0x29, 0x22, 0x23, 0x3a, 0x67, 0xec, 0x6f, 0x13, 0x9d, 0xf3, 0x6e, 0xaf, 0x38,
    0xe6, 0x24, 0x4c, 0x79, 0x5d, 0x84, 0x8b, 0x33, 0xc1, 0x11, 0x52, 0x28, 0xc7, 0x62, 0xfe, 0xe6,
];
